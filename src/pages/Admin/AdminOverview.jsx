    ...
    return (
        <div className="max-w-6xl text-black-text">
            <header className="mb-12">
                <h1 className="luxury-text text-3xl tracking-widest uppercase mb-2 text-black-text">Dashboard Overview</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-onyx/[0.03] border border-onyx/5 p-8 rounded-sm shadow-sm">
                    <h3 className="text-[11px] tracking-[0.3em] uppercase mb-8 opacity-60 text-black-text">Recent Sales</h3>
                    <div className="space-y-6">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="flex justify-between items-center border-b border-onyx/5 pb-4 last:border-0 last:pb-0">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-onyx/10 flex items-center justify-center text-[10px] text-black-text">#00{i}</div>
                                    <div>
                ...
                <div className="bg-onyx/[0.03] border border-onyx/5 p-8 rounded-sm flex items-center justify-center">
